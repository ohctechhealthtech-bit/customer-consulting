...
router.get('/customers-with-responses/export', adminController.exportResponsesExcel);
router.get('/customers-with-responses/export/pdf', adminController.exportResponsesPdf);
