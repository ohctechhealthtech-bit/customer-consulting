...
WHERE question_key IN (
  'personal.dob',
  'address.line1', 'address.line2', 'address.city', 'address.state', 'address.country', 'address.pin',
  'medical.existingConditions', 'medical.currentMedications', 'medical.allergies', 
  'medical.previousSurgeries', 'medical.emergencyContactName', 'medical.emergencyContactNumber',
  'additional.contactMethod', 'additional.notes', 'additional.occupation', 'additional.income', 'additional.comments'
);
